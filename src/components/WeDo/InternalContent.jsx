...
import internalContentImg from "../../images/internal-contentpng.png";

const InternalContent = () => {
    return (
        <div className="WeDo InternalContent py-5">
                ...
                <div className="mt-5">
                    <div className="row d-flex flex-row align-items-center">
                        ...
                        <div className="col-xl-6 col-lg-12 mt-xl-0 mt-3 d-flex justify-content-xl-start justify-content-center">
                            <img src={internalContentImg} alt="" className="WeDo__img"/>
                        </div>
                    </div>
                </div>
            </div>
